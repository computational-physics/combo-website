						...
						<ul class="list-group">
	                        <li class="list-group-item">
	                            ...
	                            <div class="list-group-item-text">
	                                <p>As long as your English is qualified, you may apply. The chance will increase with a high GPA (> 85 preferred, a low GPA may result in a academic score of 0) and scientific papers published (SCI, top 50% in category).</p>
	                            </div>
	                        </li>
	                        <li class="list-group-item">
