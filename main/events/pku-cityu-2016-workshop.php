	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-9">
				<div class="row">
					<div class="col-xs-12">
						<h3>Joint Workshop on</h3>
                        <h1>Disorder and Disordered Materials</h1>
						<p class="lead">
                            Department of Physics and Materials Science, City University of Hong Kong
                            <br />International Center of Quantum Materials, Peking University
                        </p>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <ul>
                                    <li>Xun-Li Wang & Ruirui Du</li>
                                </ul>
                                <h4>Organizing Committee</h4>
                                <ul>
                                    <li>Xin Wang (AP, CityU)</li>
                                    <li>Jun Fan (AP, CityU)</li>
